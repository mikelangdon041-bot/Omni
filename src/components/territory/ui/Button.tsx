...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-primary text-primary-fg hover:bg-primary-hover shadow-sm disabled:opacity-60",
  secondary:
  ...
  danger:
    "bg-status-error text-white hover:opacity-90 shadow-sm disabled:opacity-60",
};
