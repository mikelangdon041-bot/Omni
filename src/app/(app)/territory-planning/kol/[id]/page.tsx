      ...
      <div className="mt-4 border-t border-border pt-4">
        ...
        {editContact ? (
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <Input label="Title / position" value={v("title_position")} onChange={(e) => set("title_position", e.target.value)} />
            <Input label="Specialty" value={v("specialty")} onChange={(e) => set("specialty", e.target.value)} />
            <Input label="Institution" value={v("institution")} onChange={(e) => set("institution", e.target.value)} />
